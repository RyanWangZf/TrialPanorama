#!/usr/bin/env python3
"""
Runner script for the study search benchmark.
"""
import os
import json
import argparse
...
from benchmark.tasks import StudySearchTask

def run_benchmark(args):
    """
    Run the study search benchmark with the given arguments.
    ...
    task_name = "study_search"

    # Load dataset
    _, test_data = data.load_study_search_data(task_config.data_path)
    ...
    # Create task
    task = StudySearchTask(system_prompt=args.system_prompt)
...
def main():
    ...
    parser = config.create_arg_parser("study_search")
