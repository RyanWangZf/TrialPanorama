#!/usr/bin/env python3
"""
Runner script for the study screening benchmark.
"""
...
from benchmark.tasks import StudyScreeningTask

def run_benchmark(args):
    """
    Run the study screening benchmark with the given arguments.
    ...
    # Load dataset
    _, test_data = data.load_study_screening_data(task_config.data_path)
    ...
    # Create task
    task = StudyScreeningTask(system_prompt=args.system_prompt)
...
def main():
    ...
    parser = config.create_arg_parser("study_screening")
